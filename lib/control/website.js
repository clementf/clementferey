...
try {
	var experiences = yaml.safeLoad(fs.readFileSync(__base + 'lib/model/experiences.yml', 'utf8'));
} catch (e) {
	console.log(e);
}
try {
...
try {
	var seo = yaml.safeLoad(fs.readFileSync(__base + 'lib/model/seo.yml', 'utf8'));
} catch (e) {
	console.log(e);
}
...
exports.experiences = function(req, res) {
	var id = req.params.id;
	var experience = experiences[id];
	res.render('experiences', {
		data: experience,
		seo: seo.experience[id]
	});
};
